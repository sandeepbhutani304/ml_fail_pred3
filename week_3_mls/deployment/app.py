...
model_path = hf_hub_download(repo_id="sandtemp01/ml-fail-pred-model-hf", filename="best_machine_failure_model_v1.joblib")
model = joblib.load(model_path)

# Streamlit UI for Machine Failure Prediction
st.title("Machine Failure Prediction App-CD")
st.write("""
